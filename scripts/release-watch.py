...
def main() -> None:
    ...
    repos_cmd.add_argument("--dry-run", action="store_true", help="Preview without writing state")
    ...
    check_cmd.add_argument("--dry-run", action="store_true", help="Preview without writing state")
    ...
    status_cmd.add_argument("--dry-run", action="store_true", help="Preview without writing state")
    ...
    digest_cmd.add_argument("--dry-run", action="store_true", help="Preview without writing state")
    ...
    if args.command == "repos":
        ...
        result = checker.generate_digest(check_first=args.check)
        if checker.dry_run:
            result["dry_run"] = True
        print(json.dumps(result, indent=2))
    else:
